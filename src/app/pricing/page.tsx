...
const tiers = [
  {
    ...
    price: "$0",
    period: "forever",
    description: "Get started with UEFN AI assistance. No credit card required.",
    cta: "Get Started",
    ctaHref: "/signup",
    highlighted: false,
  },
  {
    ...
    description: "Full power for serious UEFN creators. Everything you need to ship faster.",
  ...
  },
  {
    ...
    price: "TBD",
    period: "",
    description: "For studios and professional teams. Coming soon.",
    cta: "Get Notified",
    ctaHref: "/#waitlist",
    highlighted: false,
    comingSoon: true,
...
const featureMatrix: FeatureRow[] = [
  ...
  { name: "Syntax validation", free: true, pro: true, enterprise: true },
  { name: "Device config validation", free: false, pro: true, enterprise: true },
  { name: "Procedural level assist", free: false, pro: true, enterprise: true },
  { name: "Project-aware QA", free: false, pro: true, enterprise: true },
  { name: "Architecture review", free: false, pro: false, enterprise: true },
  { name: "Projects", free: "1", pro: "5", enterprise: "Unlimited" },
  { name: "Companion app", free: true, pro: true, enterprise: true },
