...
const tiers = [
  {
    ...
    price: "$0",
    period: "forever",
    description: "Start generating Verse scripts and explore the platform",
    features: [
  ...
  },
  {
    ...
    price: "$29",
    period: "/month",
    description: "Full map generation, visual editing, and 3D preview",
    features: [
      "500 Verse scripts/mo",
      "500 AI operations/mo",
      "Full map generation",
      "Device recipes & wiring",
      "Widget editor & .uasset output",
      "3D scene preview",
      "Up to 5 projects",
    ],
  ...
  },
  {
    ...
    price: "Coming",
    period: "soon",
    description: "Unlimited generation for studios and teams",
    features: [
